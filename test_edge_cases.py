...
project_dir = os.path.join(current_dir, "project") if os.path.exists(os.path.join(current_dir, "project")) else current_dir
...
def run_all_tests():
    ...
    # Test 6
    print("\n[TEST 6/8] Testing Idempotency & Unique Task UUID Guarantee...")
    try:
